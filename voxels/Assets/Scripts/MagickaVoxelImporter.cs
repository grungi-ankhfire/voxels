...
public struct MagickaVoxelModel {
     public Voxel[][][] voxels;
...
public static class MagickaVoxelImporter {
    ...
    public static MagickaVoxelModel MagickaVoxelImport(string fileName) {
        ...
        if (magic == "VOX ")
        {
            ...
            while (stream.BaseStream.Position < stream.BaseStream.Length)
            {
                ...
                if (chunkName == "SIZE")
                {
                    ...
                    result.size = new int[3] {sizex, sizey, sizez};

                    voxels = new Voxel[sizex][][];
                    for (int x = 0; x < sizex; x++) {
                        voxels[x] = new Voxel[sizey][];
                        for (int y = 0; y < sizey; y++) {
                            voxels[x][y] = new Voxel[sizez];
                        }
                    }
